...
const Cards = ({ name, id, img }) => {

    return (
        <div className="bg-blue-500 shadow-lg shadow-black mt-32 w-72 h-80 rounded-2xl 
        ...
        <div className="bg-yellow-300 w-44 h-44 rounded-full absolute top-20">
          <img className="absolute z-1" src={img} alt="pokemon-image"></img>
        </div>
        </div>
    )
}
